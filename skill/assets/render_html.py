...
""")
    ...
    # audio player: serve from local relative path (audio/podcast.mp3)
    # IMPORTANT: do NOT use GitHub Release URLs — they 302 redirect to Azure
    # Blob with a 1-hour signed token, which breaks on mobile browsers
    # (especially WeChat/XHS in-app) and podcast apps.
